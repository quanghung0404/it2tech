...
if(! class_exists('EasyDiscussFacebookApiException') )
{
	class EasyDiscussFacebookApiException extends Exception
	{
		/**
	...
	abstract class BaseFacebook
	{
	  ...
	  protected function getUserFromAccessToken() {
	    try {
	      ...
	      return $user_info['id'];
	    } catch (EasyDiscussFacebookApiException $e) {
	      return 0;
	    }
	  }
	   ...
	   *
	   * @return mixed The decoded response object
	   * @throws EasyDiscussFacebookApiException
	   */
	  ...
	  protected function makeRequest($url, $params, $ch=null) {
	    ...
	    if ($result === false) {
	      $e = new EasyDiscussFacebookApiException(array(
