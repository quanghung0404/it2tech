ed.require(['edq'], function($) {
	...
	var nextButton = $('[data-ed-vbulletin-next]');

	nextButton.on('click', function() {

		EasyDiscuss.ajax('admin/views/migrators/checkPrefix', {
			"prefix": $('[data-ed-vbulletin-prefix]').val()
		}).done(function(prefix) {

			nextButton.hide();
			$('[data-ed-vbulletin-migrator]').removeClass('hide');
		
		}).fail(function(message) {
			$('[data-progress-status]').html(message);
		});
