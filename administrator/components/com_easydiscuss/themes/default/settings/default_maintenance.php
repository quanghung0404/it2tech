	...
	<div class="row">
		<div class="col-md-6">
					...
					<div class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-md-7"
								...
								<input type="text" name="notifications_history" class="form-control form-control-sm text-center" style="text-align:center;" value="<?php echo $this->config->get( 'notifications_history' );?>" /> <span><?php echo JText::_( 'COM_EASYDISCUSS_DAYS' ); ?></span>
							</div>
						</div>
						<div class="form-group">
							<div class="col-md-5 control-label">
							...
							>
								<input type="text" name="main_orphanitem_ownership" class="form-control form-control-sm text-center" style="text-align: center;" value="<?php echo $this->config->get('main_orphanitem_ownership', $this->defaultSAId );?>" />
							</div>
						</div>
					</div>
				</div>
			...
			<div class="panel">
				...
				<div id="option03" class="panel-body">
					<div class="form-horizontal">
						<div class="form-group">
							<div class="col-md-5 control-label">
								<label>
							...
							>
								<input type="text" name="guest_usergroup" class="form-control form-control-sm text-center" style="text-align: center;" value="<?php echo $this->config->get('guest_usergroup', 1 );?>" />
							</div>
						</div>
					</div>
				</div>
					...
					<div class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-md-7"
								...
								>
								<input type="text" name="main_mailqueuenumber" style="text-align:center;" class="form-control form-control-sm text-center" value="<?php echo $this->config->get('main_mailqueuenumber' );?>" />
						...
						<div class="form-group">
							...
							>
								<input type="text" name="main_notification_max_length" class="form-control form-control-sm text-center" style="text-align:center;" size="5" value="<?php echo $this->config->get('main_notification_max_length');?>" />
							</div>
						</div>
					</div>
				</div>
