...
<form action="index.php" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
    ...
    <div class="app-tabs">
        <ul class="app-tabs-list g-list-unstyled">
            ...
            <li class="tabItem <?php echo $active == 'parser' ? ' active' : '';?>">
                <a href="#parser" data-ed-toggle="tab">
                    <?php echo JText::_('COM_EASYDISCUSS_CATEGORY_EMAIL_PARSING');?>
                </a>
            </li>
    ...
    <div class="tab-content">
		...
		<?php echo $this->output('admin/categories/form.parser'); ?>
