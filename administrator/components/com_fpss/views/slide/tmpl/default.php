	...
	<form action="index.php" method="post" name="adminForm">
		<div class="fpssTabs">
			<ul>
				...
				<li><a href="#fpssSlidePermissionsTab"><?php echo JText::_('FPSS_PERMISSIONS'); ?></a></li>
				<?php endif; ?>
			</ul>
			<div id="fpssSlideMainTab">
				...
				<div class="fpssField">
					<div id="cpanel"<?php if(version_compare(JVERSION, '3.0', 'ge')) { echo ' class="J3"';}?>>
			...
			<div id="fpssSlideAdvancedTab">
				<div class="params-block">
					<table class="fpssTable" cellspacing="0">
					  ...
					  <tr>
					    <td class="key">
					      <label><?php echo JText::_('FPSS_AUTHOR'); ?></label>
					    </td>
					    <td><span id="fpssAuthor"><?php echo $this->lists['created_by']; ?></span>
					      <div class="button2-left">
					        <div class="blank"> <a class="modal button btn" rel="{handler:'iframe', size: {x: 800, y: 500}}" href="index.php?option=com_fpss&amp;view=extension&amp;task=com_users"><?php echo JText::_('FPSS_SELECT_USER'); ?></a> </div>
					      </div>
					  ...
					  <tr>
					    <td class="key">
					      <label><?php echo JText::_('FPSS_AUTHOR_ALIAS'); ?></label>
					    </td>
					    <td><input type="text" name="params[authorAlias]" value="<?php echo $this->row->authorAlias; ?>" /></td>
					  </tr>
					  <tr>
					    <td class="key">
			...
			<?php if(version_compare( JVERSION, '1.6.0', 'ge' )) : ?>
			<div id="fpssSlidePermissionsTab">
			<?php echo $this->rules; ?>
			</div>
			<?php endif; ?>
		</div>
