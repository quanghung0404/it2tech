...
<div class="tab-content">
	<div class="tab-pane in active" id="modules" data-tab>
		<ul class="modules-list list-reset">
			...
			<li>
				<div class="checkbox">
					<input type="checkbox" id="module-<?php echo $module->element; ?>" value="<?php echo $module->element;?>" checked="checked" data-checkbox data-checkbox-module <?php echo $module->disabled ? 'disabled':''; ?> />
