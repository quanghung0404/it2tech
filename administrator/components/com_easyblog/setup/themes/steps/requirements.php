		...
		<tbody>
			<tr class="<?php echo version_compare($phpVersion, '5.3.10') == -1 ? 'error' : '';?>">
				<td>
					<div class="clearfix">
						...
						<i class="ies-help" data-original-title="<?php echo JText::_('COM_EASYBLOG_INSTALLATION_PHP_VERSION_TIPS');?>" data-toggle="tooltip" data-placement="bottom"></i>

						<?php if(version_compare($phpVersion , '5.3.10') == -1 ){ ?>
						<a href="http://docs.stackideas.com/administrators/welcome/getting_started" class="pull-right btn btn-es-danger btn-mini"><?php echo JText::_('COM_EASYBLOG_INSTALLATION_FIX_THIS');?></a>
						<?php } ?>
					</div>
				</td>
			...
			<tr class="<?php echo !$gd ? 'error' : '';?>">
				<td>
					<div class="clearfix">
						...
						<i class="ies-help" data-original-title="<?php echo JText::_('COM_EASYBLOG_INSTALLATION_PHP_GD_TIPS');?>" data-toggle="tooltip" data-placement="bottom"></i>

						<?php if( !$gd ){ ?>
						<a href="http://docs.stackideas.com/administrators/setup/gd_library" target="_blank" class="pull-right btn btn-es-danger btn-mini"><?php echo JText::_('COM_EASYBLOG_INSTALLATION_FIX_THIS');?></a>
						<?php } ?>
					</div>
				</td>
				<td class="text-center text-success">
			...
			<tr class="<?php echo !$curl ? 'error' : '';?>">
				<td>
					<div class="clearfix">
						...
						<?php if (!$curl) { ?>
						<a href="http://docs.stackideas.com/administrators/setup/curl" target="_blank" class="btn btn-primary btn-xs"><?php echo JText::_('COM_EASYBLOG_INSTALLATION_FIX_THIS');?></a>
						<?php } ?>
					</div>
				</td>
				<td class="text-center text-success">
			...
			<tr class="<?php echo $magicQuotes ? 'error' : '';?>">
				<td>
					<div class="clearfix">
						...
						<?php if ($magicQuotes) { ?>
						<a href="http://docs.stackideas.com/administrators/setup/magic_quotes" target="_blank" class="btn btn-primary btn-xs"><?php echo JText::_('COM_EASYBLOG_INSTALLATION_FIX_THIS');?></a>
						<?php } ?>
					</div>
				</td>
				<td class="text-center text-success">
			...
			<tr>
				<td>
					...
					<i class="ies-help" data-original-title="<?php echo JText::_('COM_EASYBLOG_INSTALLATION_MYSQL_VERSION_TIPS' );?>" data-toggle="tooltip" data-placement="bottom"></i>
				</td>
				<td class="text-center text-success">
					5.0.4
				</td>
