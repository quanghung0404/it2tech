...
<head>
	...
	<link type="text/css" href="<?php echo EB_SETUP_URL;?>/assets/icons/font-awesome/css/font-awesome.min.css" rel="stylesheet">
	<link type="text/css" href="<?php echo EB_SETUP_URL;?>/assets/icons/ionicons/css/ionicons.min.css" rel="stylesheet">
	<link type="text/css" href="<?php echo EB_SETUP_URL;?>/assets/styles/theme.css" rel="stylesheet" />
	
	<script src="<?php echo EB_SETUP_URL;?>/assets/scripts/jquery.js" type="text/javascript"></script>
	<script src="<?php echo EB_SETUP_URL;?>/assets/scripts/bootstrap.min.js" type="text/javascript"></script>
	...
	<div class="header text-center">
		<div class="container">
			<div class="col-cell" style="padding-right: 20px;">
				<img src="<?php echo EB_SETUP_URL;?>/assets/images/logo.png" height="64" />
			</div>
			<div class="col-cell text-left">
				...
				<div>
					<?php echo JText::_('The best blogging platform for your Joomla! site.');?>
				</div>
			</div>
