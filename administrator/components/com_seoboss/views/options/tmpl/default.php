...
<?php echo JText::_( 'SEO_HIGHLIGHT_KEYWORDS_DESC' ) ?>
         <br/>
         <strong>Enabling this feature can cause performance slowdown.
           Also you may need to <a href="index.php?option=com_config&view=component&component=com_seoboss">enable UTF-8 support for SEO Boss</a></strong>
       </td>
  </tr>
  <tr>
