...
var c=g.selection.getParent(),d=a(c).css("color");b.colorpickerToggle().prop("checked",c.style.color),b.updateFontColorUI(d)},setFontColor:function(a){b.lastUpdatedViaFontColorUI=!0,g.inline.toggleStyle("color: "+a),b.updateFontColorUI(a)},updateFontColorUI:function(a){b.updatingFontColorUI=!0,!a&&(a="#000"),b.fontColorCaption().css("backgroundColor",a),b.fontColorPicker().colorpicker("setColor",a),b.updatingFontColorUI=!1},removeFontColor:function(){g.inline.removeStyleRule("color")},populateFontFamily:function(){if(b.lastUpdatedViaFontFamilyUI)return b.lastUpdatedViaFontFamilyUI=!1,void 0;
...
},selectedTemplate:function(a){e.manager().addClass("is-editing-template"),b.templateId().val(a)},"{selectTemplate} click":function(a){var c=a.data("uid"),d=a.data("blank");return d?(e.frame().removeClass("show-templates"),e.autosave.start(),void 0):(EasyBlog.ajax("site/views/composer/renderTemplate",{uid:c}).done(function(a,d,f){b.selectedTemplate(c),e.autosave.start(),f&&e.document.loadDocument(f),e.frame().removeClass("show-templates"),b.trigger("composerSelectTemplate",[c,a,d,f])}),void 0)},"{deleteTemplate} click":function(a,c){c.stopPropagation();
...
},views:{show:function(a){h.switchClass("view-"+a),b.view().removeClass("active").where("name",a).addClass("active"),"revisions"==a&&b.manager().removeClass("has-messages"),b.trigger("composerViewShow",[a])},hide:function(a){b.trigger("composerViewHide",[a]),b.views.show("document")}},keepalive:{timer:null,start:function(a){var d=b.keepalive,a=a||c.keepalive.interval;d.stop(),1>a||(d.timer=setTimeout(function(){d.run(a)},a))},run:function(a){EasyBlog.ajax("site/views/composer/keepAlive").always(function(){b.keepalive.start(a)
})},stop:function(){clearTimeout(b.keepalive.timer)}},autosave:{timer:null,counter:0,start:function(a){var d=b.autosave,a=a||c.autosave.interval;d.stop(),1>a||!a||(d.timer=setTimeout(function(){d.run(a)},a))},run:function(a){b.autosave.save(),b.autosave.start(a)},stop:function(){clearTimeout(b.autosave.timer)},save:function(){b.saving||(0==b.autosave.counter&&b.publishedField().val(e),b.autosave.counter++,b.save({autosave:!0,showSaveMessage:!1}).done(function(a,c){200==c.code&&(b.autosave().removeClass("hide"),b.autosaveMessage().html(c.message))
