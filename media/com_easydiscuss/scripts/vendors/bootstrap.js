ed.define('bootstrap', ['edjquery'], function($) {
...
+function ($) { "use strict";
  ...
  Button.prototype.toggle = function () {
    var $parent = this.$element.closest('[data-ed-toggle="buttons"]')
    var changed = true
  ...
  $(document).on('click.bs.button.data-api', '[data-ed-toggle^=button]', function (e) {
    var $btn = $(e.target)
...
+function ($) { "use strict";
  ...
  , trigger: 'click'
  , content: ''
  , template: '<div id="ed" class="popover popover--ed"><div class="arrow"></div><div class="popover-inner"><h3 class="popover-title"></h3><div class="popover-content"></div></div></div>'
  })
...
+function ($) { "use strict";
  ...
  $(document).on('click.bs.collapse.data-api', '[data-ed-toggle=collapse]', function (e) {
    var $this   = $(this), href
    ...
    if (!data || !data.transitioning) {
      if ($parent) $parent.find('[data-ed-toggle=collapse][data-parent="' + parent + '"]').not($this).addClass('collapsed')
...
+function ($) { "use strict";
  ...
  var toggle   = '[data-ed-toggle=dropdown]'
...
+function ($) { "use strict";
  ...
  $(document).on('click.bs.tab.data-api', '[data-ed-toggle="tab"], [data-ed-toggle="pill"]', function (e) {
    e.preventDefault()
    $(this).tab('show')
  })

  $(document).on('mouseover.popover.data-ed-api', '[data-ed-provide=popover]', function() {
    $(this)
      .popover({
        delay: {
          show: 200,
 ...
 * ======================================================================== */
  ...
  $(document).on('click.button.data-ed-api', '[data-ed-toggle-value]', function() {

    var button = $(this);
    var siblings = button.siblings("[data-ed-toggle-value]");
    var parent = button.parents('[data-ed-toggle="radio-buttons"]');
    ...
    if (parent.length > 0) {
      ...
      var value = button.data('ed-toggle-value');
  ...
  $(document).on('change.data-ed-input', '[data-ed-toggle="radio-buttons"] input[type=hidden]', function() {
    var input = $(this);
    var siblings = input.siblings("[data-ed-toggle-value]");
    var value = input.val();

    siblings
      .removeClass('active')
      .filter('[data-ed-toggle-value="' + input.val() + '"]')
      .addClass('active');
  });
 ...
 * ============================================================ */
  ...
  * ================== */
  ...
  $(document).on('focus.typeahead.data-api', '[data-ed-provide="typeahead"]', function (e) {
    var $this = $(this);
