 ...
 */
var modals_class=modals_class||'modal';var modals_disable_on_mobile=modals_disable_on_mobile||0;var modals_mobile_max_width=modals_mobile_max_width||0;var modals_open_by_url=modals_open_by_url||'';var modals_defaults=modals_defaults||{};var initModals=null;var modalsResize=null;(function($){"use strict";$(document).ready(function(){if(typeof(window['modals_defaults'])!="undefined"){initModals();}});initModals=function(){var modal_delay=null;$.each($('.'+modals_class),function(i,el){var $el=$(el);var defaults=$.extend({},modals_defaults);$.each(el.attributes,function(index,attr){if(attr.name.indexOf("data-modal-")===0){var key=$.camelCase(attr.name.substring(11));defaults[key]=attr.value;}});if(defaults['innerWidth']!=undefined){delete defaults['width'];}
