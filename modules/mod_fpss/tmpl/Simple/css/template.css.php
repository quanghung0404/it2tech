...
/* --- Slideshow Container --- */
#fpssContainer<?php echo $mid; ?>.fpss-template-simple {position:relative;width:<?php echo $width; ?>px;margin:8px auto;border-color:#ccc;border-style:solid;border-width:1px 2px 2px 1px;padding:4px;overflow:hidden;font-family:"Trebuchet MS", Trebuchet, Arial, Verdana, sans-serif;}
...
#fpssContainer<?php echo $mid; ?>.fpss-template-simple .slides-wrapper .slides .slide .slidetext {position:absolute;bottom:0;left:0;right:0;width:<?php echo $width-16; ?>px;padding:4px 8px 12px 8px;margin:0;background:url(../images/transparent_bg.png);z-index:1;}
