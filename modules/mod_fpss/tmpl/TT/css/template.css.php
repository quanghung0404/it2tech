...
/* --- Slideshow Container --- */
#fpssContainer<?php echo $mid; ?>.fpss-template-tt {position:relative;width:<?php echo $width; ?>px;margin:8px auto;padding:4px;border-color:#ccc;border-style:solid;border-width:1px 2px 2px 1px;overflow:hidden;font-family:"Trebuchet MS", Trebuchet, Arial, Verdana, sans-serif;}
