...
/* --- Slideshow Container --- */
#fpssContainer<?php echo $mid; ?>.fpss-template-uncut {position:relative;width:<?php echo $width+$sidebarWidth; ?>px;height:<?php echo $height; ?>px;margin:8px auto;border:1px solid #333;padding:0;overflow:hidden;font-family:"Trebuchet MS", Trebuchet, Arial, Verdana, sans-serif;background:#000;}
