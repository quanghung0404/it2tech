...
/* --- Slideshow Container --- */
#fpssContainer<?php echo $mid; ?>.fpss-template-fsd {position:relative;width:<?php echo $width+$sidebarWidth ?>px;height:<?php echo $height; ?>px;margin:4px auto;border:1px solid #b0b0b0;padding:0 16px;overflow:hidden;font-family:Georgia,"Times New Roman",Times,serif;background:#fff;}
