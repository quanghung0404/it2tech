...
/* --- Slideshow Container --- */
#fpssContainer<?php echo $mid; ?>.fpss-template-jj-obs {position:relative;width:<?php echo $width; ?>px;margin:8px auto;border:1px solid #ccc;padding:2px;overflow:hidden;font-family:"Trebuchet MS", Trebuchet, Arial, Verdana, sans-serif;}
