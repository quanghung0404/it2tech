...
/* --- Slideshow Container --- */
#fpssContainer<?php echo $mid; ?>.fpss-template-sleek {position:relative;width:<?php echo $width; ?>px;height:<?php echo $height; ?>px;border:2px solid #ccc;margin:4px auto;padding:0;overflow:hidden;font-family:Tahoma, Arial, sans-serif;}
