...
<div id="k2Container" class="latestView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?> row-fluid">
	...
	<div class="latestItemsContainer">
		...
		<!-- Start Items list -->
		<div class="latestItemList clearafter">
