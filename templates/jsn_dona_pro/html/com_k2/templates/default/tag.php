		...
		<div class="tagItemView">
			<?php if($item->params->get('tagItemDateCreated',1)): ?>
				<div class="createdate">
					<?php $date = printf('<span class="createdate-name">'.JHtml::_('date', $item->created, JText::_('D')).'</span>'.'<span class="createdate-month">'.JHtml::_('date', $item->created, JText::_('M')).'</span>'.'<span class="createdate-day">'.JHtml::_('date', $item->created, JText::_('d')).'</span>'); ?>
				</div>
			<?php endif; ?>
