    ...
    <div style="padding-top: 10px">
        ...
        <div>
            ...
            <?php if ($event->all_day) { ?>
                <?php $startDate = ES::date($event->start)->toFormat('d-m-Y'); ?>
                <?php $endDate = ES::date($event->end)->toFormat('d-m-Y'); ?>
            <?php } else { ?>
                <?php $startDate = ES::date($event->start)->toFormat('d-m-Y H:i'); ?>
                <?php $endDate = ES::date($event->end)->toFormat('d-m-Y H:i'); ?>
            <?php } ?>
