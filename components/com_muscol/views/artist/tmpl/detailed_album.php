...
<div class='data'>
  <table border='0' cellpadding='0' cellspacing='0' width="100%">
    <tr>
      <td valign="top" width="120"><a class='image' href='<?php echo $link; ?>'> <?php echo $image; ?> </a></td>
      <td valign="top"><div class="album_name">
          <table border='0' cellpadding='0' cellspacing='0' width="100%">
            <tr>
              <td><a href='<?php echo $link; ?>'> <?php echo $this->detail_album->name; ?> <?php echo $this->detail_album->subtitle; ?> </a></td>
              <td align="right" class="hidden-phone"><?php 
        ...
        <table border='0' cellpadding='0' cellspacing='0' width="100%">
          <tr>
            <td><div class="artist_name"> <?php echo $this->detail_album->artist_name; ?> <?php echo $this->detail_album->subartist; ?> </div></td>
            <td align="right" class="hidden-phone"><?php $comments_image = JHTML::image('components/com_muscol/assets/images/comment.png',JText::_('COMMENTS'),array("title" => JText::_('COMMENTS') ));
						$songs_image = JHTML::image('components/com_muscol/assets/images/music.png',JText::_('SONGS'),array("title" => JText::_('SONGS') ));?>
              <?php echo $songs_image . " " . $this->detail_album->num_songs; ?> <?php echo $comments_image . " " . $this->detail_album->num_comments; ?></td>
          </tr>
        </table>
        <div class="rating hidden-phone">
          <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
              <td width="60%" align="left"><?php if($this->params->get('showalbum_adminrating', 1)){ ?>
                ...
                <?php } ?></td>
              <td width="40%" align="left"><?php if($this->params->get('showalbum_added', 1) == 1 || ($this->params->get('showalbum_added', 1) == 2 && !empty($this->detail_album->added))){ ?>
