...
<div class="popbox-holiday-wrap">
    ...
    <div class="popbox-holiday-wrap__title"><?php echo JText::_('COM_EASYDISCUSS_WORK_SUPPORT_OFFDAY'); ?></div>
    <div class="popbox-holiday-wrap__subtitle">
        <?php echo JText::_('COM_EASYDISCUSS_WORK_SUPPORT_OFFDAY_DESC'); ?>
    </div>
