...
<div class="popbox-holiday-wrap">
    <i class="popbox-holiday-wrap__icon fa fa-users"></i>

    <div class="popbox-holiday-wrap__title"><?php echo JText::_('COM_EASYDISCUSS_WORK_SUPPORT_ONLINE'); ?></div>
    <div class="popbox-holiday-wrap__subtitle">
        <?php echo JText::_('COM_EASYDISCUSS_WORK_SUPPORT_ONLINE_DESC'); ?>
    </div>
