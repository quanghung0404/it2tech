...
<div id="usertype_pane_container">
	...
	<ul id="usertype_pane_left" class="reset-ul">
		<?php if($this->my->id == 0 && $acl->allowed('add_reply')) { ?>
		...
		<?php if($this->config->get('integration_twitter_enable') && ($this->config->get('integration_twitter_consumer_key') && $this->config->get('integration_twitter_consumer_secret_key'))) { ?>
