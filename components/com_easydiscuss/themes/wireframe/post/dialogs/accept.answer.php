...
<dialog>
    ...
    <title><?php echo JText::_('COM_EASYDISCUSS_REPLY_ACCEPT_TITLE'); ?></title>
    <content>
        <p class="mb-10">
        ...
        <form data-form-response method="post" action="<?php echo JRoute::_('index.php');?>">
            ...
            <?php echo $this->html('form.hidden', 'posts', 'posts', 'accept');?>
        </form>
    </content>
    <buttons>
        <button data-close-button type="button" class="btn btn-default btn-sm"><?php echo JText::_('COM_EASYDISCUSS_BUTTON_NO'); ?></button>
        <button data-submit-button type="button" class="btn btn-primary btn-sm"><?php echo JText::_('COM_EASYDISCUSS_BUTTON_YES_MARK_AS_ANSWER'); ?></button>
    </buttons>
</dialog>
