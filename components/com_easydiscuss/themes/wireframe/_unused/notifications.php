...
<a class="btn mt-15 pull-right" href="<?php echo EDR::_('index.php?option=com_easydiscuss&controller=notification&task=markreadall');?>"><?php echo JText::_('COM_EASYDISCUSS_MARK_ALL_AS_READ'); ?></a>
</div>
<hr>
					...
					<div class="media">
						<div class="media-object pull-left">
							<div class="discuss-avatar avatar-small">
								<img src="<?php echo $this->profile->getAvatar();?>" alt="<?php echo $this->escape($this->profile->getName());?>" />
							</div>
						</div>
						<div class="media-body">
							...
							<a href="javascript:void(0);" class="pull-">
								<small>
									...
									- <a href="<?php echo EDR::_($item->permalink);?>"><?php echo $item->touched; ?></a>
									<?php if($item->state != DISCUSS_NOTIFICATION_READ) { ?>
									<a href="<?php echo EDR::_('index.php?option=com_easydiscuss&controller=notification&task=markread&id=' . $item->id);?>"><?php echo JText::_('COM_EASYDISCUSS_MARK_AS_READ');?></a>
									<?php } ?>
								</small>
							</a>
						</div>
