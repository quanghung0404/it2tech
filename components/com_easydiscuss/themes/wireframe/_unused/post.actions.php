...
<div class="fd-cf discuss-admin-bar">
	...
	<div class="btn-group dropdown_ pull-right mr-5">
		...
		<ul class="dropdown-menu">
			...
			<?php if($access->canBan() && $post->canBeBanned()){ ?>
				<li>
					<a class="admin-no-status" href="javascript:void(0);" class="banUser" onclick="discuss.post.banForm('<?php echo $post->id; ?>');">
						<i class="icon-question-sign"></i> <?php echo JText::_('COM_EASYDISCUSS_ACL_OPTION_BAN_THIS_USER'); ?>
					</a>
				</li>
			<?php } ?>			
		</ul>
