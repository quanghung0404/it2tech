    ...
    <td style="text-align: center;padding: 40px 10px 0;">
        <div style="margin-bottom:15px;">
            <div style="font-family:Arial;font-size:32px;font-weight:normal;color:#333;display:block; margin: 4px 0">
                <?php echo JText::_('COM_EASYDISCUSS_EMAILS_NEW_REPLY_REQUIRE_MODERATION') ?>
            </div>
            <div style="font-size:12px; color: #798796;font-weight:normal">
                <?php echo JText::sprintf('COM_EASYDISCUSS_EMAILT_EMPLATE_HAS_REPLIED_TO_DISCUSSION', $replyAuthor, $postTitle); ?>
            </div>
        </div>
    </td>
</tr>
...
<tr>
    <td style="text-align: center;font-size:12px;color:#888">
        ...
        <a style="
                ...
                " href="<?php echo $approveURL;?>"><?php echo JText::_('COM_EASYDISCUSS_EMAIL_APPROVE_REPLY');?></a>
