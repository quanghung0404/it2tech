...
<tr>
    <td style="background: #55585d; color: #fff; line-height: 1; font-size: 18px; font-weight: bold; text-align: center; padding: 30px;">
        <?php echo JText::_('COM_EASYBLOG_NOTIFICATION_NEW_LIKE'); ?>
    </td>
</tr>
...
<tr>
    <td style="background: #fff; padding: 0 40px 40px; text-align: center">
        <div style="padding: 50px; background: #fafafa;">
            <img src="<?php echo $commentLikedActorAvatar;?>" width="60" height="60" style="border-radius: 100%; display: inline-block;" />
            <div style="padding-top: 20px 0 40px;">
                <span style="text-decoration: none; font-weight: bold; color: #247acf;"><?php echo $commentLikedActor;?></span>
