...
<div class="kmt-comment-tools-title">
	...
	</strong> | <a href="<?php echo $contentLink; ?>#kmt-form" class="kmt-addyours"><?php echo JText::_( 'COM_KOMENTO_COMMENTS_ADD_YOURS' ); ?></a>
</div>
...
<ul class="kmt-toolbar reset-ul float-li">
	...
	<li class="kmt-sort-title">
		<span><?php echo JText::_( 'COM_KOMENTO_SORT_BY' ); ?></span>
	</li>
