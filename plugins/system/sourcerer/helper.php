...
class PlgSystemSourcererHelper
{
	...
	public function __construct(&$params)
	{
		...
		$disabled_components = is_array($params->components) ? $params->components : array(explode('|', $params->components));
		$this->src_params->disabled_components = array('com_acymailing');
		$this->src_params->disabled_components = array_merge($disabled_components, $this->src_params->disabled_components);
	}
