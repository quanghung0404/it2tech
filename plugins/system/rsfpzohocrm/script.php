...
class plgSystemRSFPZohoCrmInstallerScript
{
	...
	public function postflight($type, $parent) {
		...
		<h3>RSForm! Pro Zoho CRM Plugin v1.51.0 Changelog</h3>
		...
		<a class="btn" href="https://www.rsjoomla.com/support/documentation/view-article/1410-rsformpro-zoho-crm-plugin.html" target="_blank">Read the documentation</a>
	...
	public function update($parent) {
		...
		$db 		= JFactory::getDbo();
		$columns 	= $db->getTableColumns('#__rsform_zohocrm');		
		
		if (!isset($columns['zh_debug'])) {
			$db->setQuery("ALTER TABLE `#__rsform_zohocrm` ADD `zh_debug` TINYINT( 1 ) NOT NULL AFTER `zh_merge_vars` ");
			$db->execute();
		}
	}
